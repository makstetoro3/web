...
menu = [{"name": "Контакты", "url": "first-app"},
        {"name": "Отзовы", "url": "comments"},
        {"name": "Кондитерка", "url": "contact"},
        {"name": "Выпечка", "url": "contact"}]
...
def comment():
    ...
    return render_template("comments.html", comments=comments, menu=menu)
